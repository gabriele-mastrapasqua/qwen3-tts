...
|---|---|---|---|---|---|
| [`axion-16c-ttfa`](../../configs/perf/axion-16c-ttfa.json) | Google Axion / Neoverse-V2 | 16 | `2x8` cap 8 | qualified (pre-v2, 2026-09-01) | C4 on 1.7B int8; at C6 the realtime factor measured ~1.1. The host behind the profile-environment A/B and the `QWEN_POOL_SPIN=65536` measurement |
| [`aws-c8a-16c-vnni-ttfa`](../../configs/perf/aws-c8a-16c-vnni-ttfa.json) | AMD EPYC 9R45, AWS `c8a.4xlarge` | 16 | `2x8` cap 8 | provisional (pre-v2, 2026-09-03) | C4. The host where the AVX-512-BF16 prefill default was measured: pinning `QWEN_PREFILL_MATMAT=1` moved TTFA p50 from 416 to 124 ms at C=1 |
...
| [`x86-8c-amx-single-stream-ttfa`](../../configs/perf/x86-8c-amx-single-stream-ttfa.json) | Intel Xeon Platinum 8581C | 8 | `1x8` cap 16 | qualified (pre-v2, 2026-09-01) | C1 — the only configuration on that host then faster than realtime: TTFA 93 ms, stream RTF 0.65 |
| [`x86-8c-amx-multiclient-ttfa`](../../configs/perf/x86-8c-amx-multiclient-ttfa.json) (alias `x86-8c-amx-recommended`) | same | 8 | `2x4` cap 8 | qualified (pre-v2, 2026-09-01) | C2 balanced; best measured throughput from C4 up; C4 TTFA p95 252 ms at stream RTF 1.43 |
| [`x86-8c-amx-tail-latency-ttfa`](../../configs/perf/x86-8c-amx-tail-latency-ttfa.json) | same | 8 | `4x2` cap 4 | qualified (pre-v2, 2026-09-01) | the C8 **tail** only — TTFA p95 444.7 ms against 483.6 on the two-worker profile. Everywhere else it loses, badly at low concurrency |
